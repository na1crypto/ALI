...
.mob-nav-item.active { color: #4318FF; }
.mob-nav-item.logout { color: #E02424; }
...
<a href="<?= $admin_base ?>/AI/index.php"
   class="app-item <?= $active=='ai'?'active':'' ?>">
    ...
    <span class="item-label">AI Tahlilchi</span>
        ...
        <!-- Moliyaviy Tahlil -->
        <a href="<?= $admin_base ?>/moliyaviy_tahlil.php"
           class="app-item <?= $active=='tahlil'?'active':'' ?>">
            <div class="item-icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <span class="item-label">Moliyaviy Tahlil</span>
        </a>
...
<nav class="mob-bottom-nav">
  <a href="<?= $admin_base ?>/dashboard.php" class="mob-nav-item <?= $active=='dashboard'?'active':'' ?>">
  ...
  <a href="<?= $admin_base ?>/Mahsulotlar/index.php" class="mob-nav-item <?= $active=='ombor'?'active':'' ?>">
    <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>
  ...
  <a href="<?= $admin_base ?>/sales_history.php" class="mob-nav-item <?= $active=='savdo'?'active':'' ?>">
    <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
      <polyline points="14 2 14 8 20 8"/>
  ...
  <a href="<?= $admin_base ?>/moliyaviy_tahlil.php" class="mob-nav-item <?= $active=='tahlil'?'active':'' ?>">
    <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <?php if($user_role==='superadmin'): ?>
  <a href="<?= $admin_base ?>/Xodimlar/index.php" class="mob-nav-item <?= $active=='xodimlar'?'active':'' ?>">
    <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/>
      <circle cx="9" cy="7" r="4"/>
  ...
  <a href="<?= $admin_base ?>/settings.php" class="mob-nav-item <?= $active=='sozlamalar'?'active':'' ?>">
    <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <circle cx="12" cy="12" r="3"/>
      <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/>
    </svg>
  ...
  <?php endif; ?>
  <button class="mob-nav-item logout" onclick="document.getElementById('logoutOverlay').classList.add('show')">
